...
for model in supported_models:
    table += (
        ...
        f"{tick if model.supports_empty_content else cross} | {tick if model.supports_tools_choice else cross} | {tick if model.supports_tools_choice_required else cross} | "
        f"{tick if model.supports_json_output else cross} | {tick if model.supports_json_content else cross} | {tick if model.can_assistant_last else cross} | "
