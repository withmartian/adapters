...
from tests.utils import SIMPLE_CONVERSATION_JSON_CONTENT, get_response_content_from_vcr
...
def test_sync(vcr, model_path):
    ...
    adapter_response = adapter.execute_sync(SIMPLE_CONVERSATION_JSON_CONTENT)
