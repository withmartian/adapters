...
from tests.utils import SIMPLE_CONVERSATION_SYSTEM_ONLY, get_response_content_from_vcr
...
def test_sync(vcr, model_path: str):
    ...
    adapter_response = adapter.execute_sync(SIMPLE_CONVERSATION_SYSTEM_ONLY)
...
async def test_async(vcr, model_path: str):
    ...
    adapter_response = await adapter.execute_async(SIMPLE_CONVERSATION_SYSTEM_ONLY)
